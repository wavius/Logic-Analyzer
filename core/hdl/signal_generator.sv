module signal_generator #(
  ...
  // Counter targets
  localparam COUNT_HEARTBEAT = FREQ_SYS_CLOCK / FREQ_HEARTBEAT;
  localparam COUNT_CLOCK     = FREQ_SYS_CLOCK / FREQ_CLOCK;
  localparam COUNT_BURST     = FREQ_SYS_CLOCK / FREQ_BURST;
  localparam COUNT_PULSE     = FREQ_SYS_CLOCK / FREQ_PULSE;
