...
the pixel 0,1 has the address {\it base} $+$ (00000001~000000000~0)$_2$ = {\sf 0x\baseAddressOffset 8000400},
...
\begin{figure}[h!]
   \begin{center}
       \includegraphics{../../../common/figs/Media_FPGA_Video_Pixel_Values_16.pdf}
			 ...
			 \vspace{1cm}
			 \includegraphics{../../../common/figs/Media_FPGA_Video_Pixel_Address_17_1.pdf}
