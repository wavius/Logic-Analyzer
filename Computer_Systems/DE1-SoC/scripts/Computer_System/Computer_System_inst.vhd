	component Computer_System is
		port (
			...
			logic_analyzer_0_conduit_end_export : in    std_logic_vector(15 downto 0) := (others => 'X'); -- export
			logic_analyzer_0_conduit_end_name   : out   std_logic_vector(15 downto 0)                     -- name
		);
	...
	u0 : component Computer_System
		port map (
			...
			logic_analyzer_0_conduit_end_export => CONNECTED_TO_logic_analyzer_0_conduit_end_export, -- logic_analyzer_0_conduit_end.export
			logic_analyzer_0_conduit_end_name   => CONNECTED_TO_logic_analyzer_0_conduit_end_name    --                             .name
		);
