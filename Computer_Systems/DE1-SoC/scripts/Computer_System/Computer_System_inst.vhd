	component Computer_System is
		port (
			...
			logic_analyzer_channels_data_out : out   std_logic_vector(15 downto 0);                    -- data_out
			logic_analyzer_channels_data_in  : in    std_logic_vector(15 downto 0) := (others => 'X'); -- data_in
	...
	u0 : component Computer_System
		port map (
			...
			logic_analyzer_channels_data_out => CONNECTED_TO_logic_analyzer_channels_data_out, -- logic_analyzer_channels.data_out
			logic_analyzer_channels_data_in  => CONNECTED_TO_logic_analyzer_channels_data_in,  --                        .data_in
