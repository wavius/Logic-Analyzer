...
(
    ...
    localparam PAD4 = log2ceil(64'hff200070 - 64'hff200060); 
    localparam PAD5 = log2ceil(64'hff200080 - 64'hff200070); 
    ...
    localparam PAD9 = log2ceil(64'hff201028 - 64'hff201020); 
    ...
    localparam PAD13 = log2ceil(64'hff202140 - 64'hff202100); 
    ...
    localparam PAD18 = log2ceil(64'hff205020 - 64'hff205000); 
    // -------------------------------------------------------
    ...
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 32'hff200060   ) begin
            src_channel = 20'b0000100000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0xff200070 .. 0xff200080 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 32'hff200070   ) begin
    ...
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 32'hff201020   ) begin
    ...
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 32'hff202100   ) begin
    ...
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 32'hff205000   ) begin
