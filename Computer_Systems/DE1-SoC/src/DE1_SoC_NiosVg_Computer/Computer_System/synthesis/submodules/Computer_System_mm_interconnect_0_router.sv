...
module Computer_System_mm_interconnect_0_router_default_decode
  ...
  (output [113 - 109 : 0] default_destination_id,
...
(
    ...
    localparam PAD3 = log2ceil(64'ha010000 - 64'ha000000); 
    ...
    localparam PAD18 = log2ceil(64'hff202140 - 64'hff202100); 
    ...
    localparam PAD27 = log2ceil(64'hff205020 - 64'hff205000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'hff205020;
